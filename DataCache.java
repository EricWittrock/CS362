...
class DataCache {
    ...
    public static String getTablePath(String className) {
        switch (className) {
            ...
            case "Venue":
                return "./Data/Venues.txt";
            case "Concession":
                return "./Data/Concessions.txt";
            case "ConcessionOrder":
                return "./Data/ConcessionOrders.txt";
            case "Merchandise":
                return "./Data/Merchandise.txt";
            case "MerchandiseOrder":
                return "./Data/MerchandiseOrders.txt";
            case "Script":
                return "./Data/Scripts.txt";
            case "ScriptAction":
                return "./Data/ScriptActions.txt";
            case "StreamingCompany":
                return "./Data/StreamingCompanies.txt";
            case "Wrestler":
                return "./Data/Wrestlers.txt";
            case "WrestlerSchedule":
                return "./Data/WrestlerSchedules.txt";
            case "WrestlerInsurance":
                return "./Data/WrestlerInsurances.txt";
            case "Section":
                return "./Data/Sections.txt";
            case "Budget":
                return "./Data/Budget.txt";
            case "Worker":
                return "./Data/Workers.txt";
            case "WorkerAssignment":
                return "./Data/WorkerAssignments.txt";
            case "WrestlerPayment":
                return "./Data/WrestlerPayments.txt";
            case "WorkerPayment":
                return "./Data/WorkerPayments.txt";
            case "ScriptInsurancePayment":
                return "./Data/ScriptInsurancePayments.txt";
            case "Contract":
                return "./Data/Contracts.txt";
